...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Sep 2022 pada 12.14
...
(18, 7, 7, 2, 4, '00:00', '23:00', '2022-09-12 10:18:36', '2022-09-15 02:09:57');
...
CREATE TABLE `soal` (
  ...
  `kelas_id` int(11) DEFAULT NULL,
  `mata_pelajaran_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `file_a` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_b` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_c` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_d` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `soal` (`id`, `guru_id`, `kelas_id`, `mata_pelajaran_id`, `bobot`, `file`, `type_file`, `soal`, `opsi_a`, `opsi_b`, `opsi_c`, `opsi_d`, `file_a`, `file_b`, `file_c`, `file_d`, `jawaban`, `created_at`, `updated_at`) VALUES
(1, 7, NULL, 'aasas', 'sdssd', 'hjh', 'jjh', 'jhj', 'hj', 'hj', 'hjh', 'jhj', 'hj', 'hjh', 'jhj', 'hj', 'hjh', NULL, NULL);
